<template>
  <div class="header-container" :class="isActive">
    <div class="header-logo" @click="$emit('select-section', null)">
      <svg v-if="!menuOpen" width="41" height="50" viewBox="0 0 41 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <div class="header-buttons">
      ...
      <div class="burger-menu" @click="handleMenu">
        <svg v-if="!menuOpen" width="24" height="28" viewBox="0 0 24 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 14.1866H21" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M3 7.35205H21" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M3 21.0211H21" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
